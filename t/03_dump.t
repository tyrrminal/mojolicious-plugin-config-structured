...
is(capture_output(sub { Mojolicious::Plugin::Config::Structured::Command::config_dump::run(app) }), 
  qq{db =>\n  pass => "************"\n  user => "tyrrminal"\n}, 'check non-verbose dump');

is(capture_output(sub { Mojolicious::Plugin::Config::Structured::Command::config_dump::run(app, '--reveal') }), 
  qq{db =>\n  pass => "hunter2"\n  user => "tyrrminal"\n}, 'check non-verbose dump (reveal)');

is(capture_output(sub { Mojolicious::Plugin::Config::Structured::Command::config_dump::run(app, '--verbose') }), 
  qq{/db/pass\n  Type:       Str\n  Sensitive:  Y\n  Value:      "************"\n\n/db/user\n  Type:       Str\n  Value:      "tyrrminal"\n\n}, 'check verbose dump');

is(capture_output(sub { Mojolicious::Plugin::Config::Structured::Command::config_dump::run(app, '--verbose', '--reveal') }), 
